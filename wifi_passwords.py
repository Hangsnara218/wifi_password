...
# to save contents that is sent to standard output, it needs to be specified that we want to capture the output: therefore specify the second argument as capture_output = True
# This is stored in the stdout attriube and needs to be decoded before being used as a string
